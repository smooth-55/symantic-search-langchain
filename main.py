...
old=[('投げる瞬間に頭がぶれないように注意してください。', '投げる瞬間に顔がぶれる'), ('早く投げるようにしています。', '速く投げようとしてフォームが崩れる'), ('フォームが崩れてます。', '可動域が狭くてフォームが小さくなる'), ('フォームが崩れてます。', '疲れてくるとフォームが乱れる'), ('フォームが崩れてます。', '疲れるとフォームが崩れる')]
new=[('投げる瞬間に頭がぶれないように注意してください。', '投げる瞬間に顔がぶれる'), ('早く投げるようにしています。', '速く投げようとしてフォームが崩れる'), ('フォームが崩れてます。', '可動域が狭くてフォームが小さくなる'), ('フォームが崩れてます。', '疲れてくるとフォームが乱れる'), ('フォームが崩れてます。', '疲れるとフォームが崩れる')]
new=[('投げる瞬間に頭がぶれないように注意してください。', '投げる瞬間に顔がぶれる'), ('早く投げるようにしています。', '速く投げようとしてフォームが崩れる'), ('フォームが崩れてます。', '可動域が狭くてフォームが小さくなる'), ('フォームが崩れてます。', '疲れてくるとフォームが乱れる'), ('フォームが崩れてます。', '疲れるとフォームが崩れる')]